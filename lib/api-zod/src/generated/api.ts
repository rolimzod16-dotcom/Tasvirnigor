...
export const GetContactsResponse = zod.object({
  ...
  "addressTj": zod.string().nullish(),
  "workingHoursEn": zod.string().nullish(),
  "workingHoursRu": zod.string().nullish(),
  "workingHoursTj": zod.string().nullish(),
  "labelEn": zod.string().nullish(),
  "labelRu": zod.string().nullish(),
  "labelTj": zod.string().nullish(),
  "headingEn": zod.string().nullish(),
  "headingRu": zod.string().nullish(),
  "headingTj": zod.string().nullish(),
  "subtextEn": zod.string().nullish(),
  "subtextRu": zod.string().nullish(),
  "subtextTj": zod.string().nullish(),
